...
logger.info(f'Addition: {tensor+10}')
logger.info(f'Normal multiplication: {tensor*10}')
logger.info(f'Subtraction: {tensor-10}')
logger.info(f'Matrix multiplication {torch.mm(torch.tensor([[2,3],[4,5]]),torch.tensor([[6,7],[8,9]]))}')
